...
const createMenu = async (req, res) => {
    try {
        ...
        const createMenu = await prisma.menu.create({ data: { logo: file.filename, active } })
...
const updateMenu = async (req, res) => {
    try {
        ...
        const data = await prisma.menu.update({
            ...
            data: { logo: req.file.filename , active }
        });
...
const getASubLink = async (req, res) => {
    try {
        const subLink = await prisma.subNavLink.findUnique({where: {id: req.query.id}});
...
const deleleSubLink = async (req, res) => {
    try {
        ...
        const find = await prisma.subNavLink.findUnique({where: {id: req.query.id}});
